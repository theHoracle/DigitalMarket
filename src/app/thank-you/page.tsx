        ...
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            <p className="mt-2 text-base text-muted-foreground">
              ...
              available to download below. We&apos;ve sent your reciept and all
              details to{" "}
            ...
            <p className="mt-2 text-base text-muted-foreground">
              We appreciate your order, and we&apos;re currently working on it.
          ...
          <ul className="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-muted-foreground">
            {(order.products as Product[]).map((product) => {
              ...
              const dowloadUrl = (product.product_files as ProductFile)
                .url as string;
          ...
          />
          <div className="m-16 border-t border-gray-200 text-right">
            <Link
              href="/products"
