...
const ImageSlider = ({ urls }: ImageSliderProps) => {
  ...
  return (
    ...
    group-hover:opacity-100 transition w-full h-full"
      >
        <button
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          <ChevronRight className="h-4 w-4" aria-label="previous image" />
        </button>
        ...
        >
          <ChevronLeft className="h-4 w-4" aria-label="next image" />
        </button>
      </div>
      <Swiper
