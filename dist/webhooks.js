...
var RecieptEmail_1 = require("./components/emails/RecieptEmail");
        ...
        switch (_c.label) {
            case 0:
                ...
                try {
                    ...
                    return [2 /*return*/, res
                            .status(400)
                            .send("Webhook Error: ".concat(error instanceof Error ? error.message : "UNKNOWN ERROR!"))];
                }
                session = event.data.object;
                if (!((_a = session.metadata) === null || _a === void 0 ? void 0 : _a.userId) || !((_b = session === null || session === void 0 ? void 0 : session.metadata) === null || _b === void 0 ? void 0 : _b.userId)) {
            ...
            case 2:
                ...
                user = users[0];
                if (!user) {
                    return [2 /*return*/, res.status(400).json({ error: "NO SUCH USER EXIST!" })];
                }
                return [4 /*yield*/, payload.find({
                        collection: "orders",
                        depth: 2,
            ...
            case 3:
                ...
                order = orders[0];
                if (!order) {
                    return [2 /*return*/, res.status(400).json({ error: "NO SUCH ORDER EXIST!" })];
                }
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        from: "TheHoraclMart <princemjames2@gmail.com>",
                        to: [user.email],
                        subject: "Thanks for your order! This is your reciept.",
                        html: (0, RecieptEmail_1.RecieptEmailHtml)({
                            date: new Date(),
                            email: user.email,
