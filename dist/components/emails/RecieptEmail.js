...
exports.RecieptEmailHtml = exports.RecieptEmail = void 0;
var utils_1 = require("../../lib/utils");
var components_1 = require("@react-email/components");
var React = __importStar(require("react"));
var date_fns_1 = require("date-fns");
var RecieptEmail = function (_a) {
    var email = _a.email, date = _a.date, orderId = _a.orderId, products = _a.products;
    var total = products.reduce(function (total, product) { return total + product.price; }, 0) + 1;
...
exports.RecieptEmail = RecieptEmail;
var RecieptEmailHtml = function (props) {
    return (0, components_1.render)(React.createElement(exports.RecieptEmail, __assign({}, props)), {
        pretty: true,
    });
};
exports.RecieptEmailHtml = RecieptEmailHtml;
var main = {
